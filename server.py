...
def generate_log_file(args):
    savepath = './logs_3/' + args.get_dataset_name() + '_' + args.get_model_name() + '_' + args.get_dd_type() + '_' +str(args.get_num_workers())+'_'+ args.get_attack_type1() + '_' +args.get_attack_type2()+'_'+ args.get_rule() +'+ Kmeans + Mean Trust Scores '+ '_' + str(
        args.get_malicious_rate()) + '_' + str(args.get_local_epochs()) + '.log'
    return savepath


def run_exp(num_workers, frac_workers, attack_type1,attack_type2, rule, replace_method, dataset, malicious_rate,
    ...
    args.set_attack_type1(attack_type1)
    args.set_attack_type2(attack_type2)
    ...
    flEnv = FL(dataset_name=args.get_dataset_name(), model_name=args.get_model_name(), dd_type=args.get_dd_type(),
               ...
               rate_unbalance=args.get_rate_unbalance(), alpha=args.get_alpha(), source_class=args.get_source_class(),trustScores=args.get_trust)

    flEnv.run_experiment(attack_type1=args.get_attack_type1(),attack_type2=args.get_attack_type2(), malicious_behavior_rate=args.get_malicious_behavior_rate(),
