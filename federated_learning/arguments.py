...
class Arguments:
    ...
    def __init__(self, logger):
        ...
        self.rule = "fedavg"
        self.attack_type1 = "no_attack"
        self.attack_type2 = "no_attack"
    ...
    def set_trust(self, trustScores):
    ...
    def get_attack_type1(self):
        return self.attack_type1

    def set_attack_type1(self, attack_type):
        self.attack_type1 = attack_type

    def get_attack_type2(self):
        return self.attack_type2
    

    def set_attack_type2(self, attack_type):
        self.attack_type2 = attack_type
